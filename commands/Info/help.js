...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if (args[0]) {
            ...
            .addFields([{name: `✍ **__CÓDIGO PÚBLICO__**`, value: `[\`DESCARGA EL CÓDIGO GRATIS!\`](https://github.com/Ikergonzalez4)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por qmiras44 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
